...
pub const TERMINAL_INSTRUCTIONS: [&str; 7] = [
    "Use Alt+Left/Right to resize panels.",
    "Click on a panel to focus it.",
    "Drag the divider between panels to resize them.",
    "Use PageUp/PageDown or mouse wheel to scroll through output.",
    "Use Alt+Up/Down to scroll through output.",
...
pub const AI_INSTRUCTIONS: [&str; 5] = [
...
pub const HELP_FEATURES: [&str; 2] = [
    "  - The first command from AI responses will be automatically placed in your terminal input and executed",
    "  - System information is provided to the AI for better command compatibility",
];

// UI messages
pub const THINKING_MESSAGE: &str = "Thinking...";
pub const COMMAND_COPIED_MESSAGE: &str = "✅ Command copied to terminal: ";
pub const COMMAND_EXECUTED_MESSAGE: &str = "✅ Command copied and executed: ";
pub const EXTRACTED_COMMANDS_HEADER: &str = "Extracted Commands:";
pub const COMMAND_BUTTONS_HELP: &str = "📋 - Copy command to terminal | ▶️ - Copy and execute command";
...
pub const OLLAMA_PULL_INSTRUCTIONS: &str = "Run 'ollama pull llama2' in the terminal to get started."; 